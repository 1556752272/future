...
public class magicwand6 : wand
{
    ...
    Collider2D[] monsters = Physics2D.OverlapCircleAll(transform.position, searchRadius, targetLayerMask);
        ...
        if (monsters.Length > 0)
        {
            ...
            bullet = ResManager.Load<MagicBullet6>("MagicBullet6", LVManager.Instance.TempObjRoot);
